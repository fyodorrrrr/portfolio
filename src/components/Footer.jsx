export default function Footer() {
  return (
    <footer className="bg-[#111111] text-[#cfcfcf] py-8">
      ...
      <div className="mt-8 text-center text-xs text-[#8f8f8f] opacity-70 font-sans">
