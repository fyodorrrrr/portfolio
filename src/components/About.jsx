export default function AboutMe() {
  return (
    <section id="about" className="w-full bg-neutral-800 text-white py-20 px-4 sm:px-8 font-sans">
            ...
            <div className="grid grid-cols-1 gap-6">
              <div className="bg-neutral-750 p-6 rounded-xl border-l-4 border-green-400">
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="font-semibold text-lg text-white font-heading">Web Development</h3>
                </div>
              ...
              <div className="bg-neutral-750 p-6 rounded-xl border-l-4 border-green-400">
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="font-semibold text-lg text-white font-heading">AI & Machine Learning</h3>
                </div>
                <p className="text-gray-300 text-sm">
              ...
              <div className="bg-neutral-750 p-6 rounded-xl border-l-4 border-green-400">
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="font-semibold text-lg text-white font-heading">Problem Solving</h3>
                </div>
                <p className="text-gray-300 text-sm">
